...
`,
    titleAr: 'مدارك المتحدة توقّع اتفاقية لمدة 25 عاماً لتطوير الحرم الثالث لمدارس MGIS في الرياض',
    excerptAr: 'من خلال شركتها التابعة «شركة مينا الحديثة للتعليم»، وقّعت مدارك المتحدة اتفاقية استثمارية لمدة 25 عاماً لتطوير الحرم الثالث لمدارس Modern Global International Schools (MGIS) في مدينة الرياض.',
    bodyAr: `
...
`,
    titleAr: 'مدرسة المعارف الأمريكية تحصد جائزة الرفاه المدرسي',
    excerptAr: "حصلت مدرسة المعارف الأمريكية على جائزة الرفاه المدرسي (WAS)، المقدّمة بالشراكة مع المكتب الوطني للأطفال (National Children's Bureau)، والمعتمدة حتى عام 2029.",
    bodyAr: `
...
export const schools: School[] = [
  {
    ...
    descriptionAr:
      'مدرسة أمريكية في دبي تأسست عام 1987، وتقدم التعليم للطلاب من مرحلة الطفولة المبكرة حتى المرحلة الثانوية وصولاً إلى شهادة الثانوية الأمريكية.',
    overviewAr:
    ...
    highlightsAr: [
      'تأسست عام 1987، وتُعد من أعرق المدارس الأمريكية في دبي',
      'منهج أمريكي متوافق مع المعايير التعليمية الأمريكية، وصولاً إلى شهادة الثانوية الأمريكية',
  ...
  },
  {
    ...
    descriptionAr:
      'منهج أمريكي مُعزّز بإطار البكالوريا الدولية (IB)، من مرحلة الحضانة حتى الصف التاسع، في قلب مدينة الرياض.',
    overviewAr:
    ...
    highlightsAr: [
      'منهج أمريكي مُصمم وفق إطار برنامج السنوات الابتدائية للبكالوريا الدولية (IB-PYP)',
      'متوسط عدد الطلاب في الفصل 18 طالباً، وبحد أقصى 24 طالباً',
      'مرافق تعليمية متكاملة تشمل مختبرات العلوم والفنون والموسيقى والمسرح',
  ...
  },
  {
    ...
    descriptionAr:
      'تقديم تجارب تعليمية مبتكرة تلهم الفضول والإبداع، وتغرس شغف التعلّم والتميّز المستمر.',
    overviewAr:
      'تُعد مدرسة MGIS في المدينة الرقمية أحدث مدارس الشبكة، وتتميز ببيئة تعليمية غنية بالتكنولوجيا وثلاثية اللغات، تقوم على الشراكة الفاعلة مع الأسرة وتعزيز حب التعلّم لدى الطلاب.',
    highlightsAr: [
      'منهج أمريكي يستند إلى معايير Common Core الأمريكية',
      'توظيف متقدم للتكنولوجيا في جميع الفصول الدراسية',
      'تعليم بثلاث لغات: الإنجليزية والعربية والفرنسية',
  ...
  },
  {
    ...
    descriptionAr:
      'مدرسة مرتقبة في مدينة الشارقة المستدامة تقدم المنهج الأمريكي من مرحلة رياض الأطفال حتى الصف الثاني عشر، باستثمار يبلغ 50 مليون دولار أمريكي، وبطاقة استيعابية مصممة لنحو 2,435 طالباً، ويجري تطويرها بالشراكة مع هيئة الشارقة للاستثمار والتطوير «شروق».',
    overviewAr:
      'مدرسة مرتقبة في مدينة الشارقة المستدامة، يجري تطويرها بالشراكة بين مدارك وهيئة الشارقة للاستثمار والتطوير «شروق». وتقدم المدرسة المنهج الأمريكي من مرحلة رياض الأطفال حتى الصف الثاني عشر، باستثمار يبلغ 50 مليون دولار أمريكي، وبطاقة استيعابية مصممة لنحو 2,435 طالباً. وتقع المدرسة ضمن إحدى أبرز المجتمعات المستدامة في إمارة الشارقة، وقد صُممت لتوفير بيئة تعليمية ترتكز على الابتكار والرفاه والتعلّم التعاوني.',
    highlightsAr: [
      'المنهج الأمريكي من مرحلة رياض الأطفال حتى الصف الثاني عشر',
      'حرم مدرسي بقيمة استثمارية تبلغ 50 مليون دولار أمريكي في مدينة الشارقة المستدامة',
      'مصمم لاستيعاب نحو 2,435 طالباً على مساحة 29,275 م²',
      'مختبرات للعلوم وتكنولوجيا المعلومات والروبوتات والهندسة والرياضيات، إلى جانب مساحات مخصصة للابتكار والتصميم والتصنيع',
      'ثلاث مكتبات، واستوديوهات للفنون، ومسرح «الصندوق الأسود»، وقاعة متعددة الأغراض تتسع لـ500 شخص',
      'مركز لدعم التعلّم يضم غرفاً للعلاج والتكامل الحسي، إلى جانب عيادات مخصصة',
      'صالة رياضية داخلية، ومسبح رئيسي ومسبح مخصص للمتعلمين، ومساحات ترفيهية على سطح المبنى',
      'مساحات خضراء، وحديقة نباتية، وممرات مشاة مظللة',
    ],
  },
];
